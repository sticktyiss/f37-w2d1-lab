...
//CODE HERE
jsNinja = () => console.log('I am JS ninja')
jsNinja()
...
let nameGreeting = nameCheck('Jason')
...
console.log(bestMovie('Demon Slayer'))
...
bigOrSmall = nums => {
  for(let i=0; i<bigOrSmallArray.length; i++) {
    nums[i]>100 ? answers.push('BIG') : answers.push('small')
  }
...
//CODE HERE
upStr = str => console.log(str.toUpperCase())
upStr(sampleString)
...
*/
emailCheck = email => {
  str = String(email.trim()).includes('@') ? 'email verified' : 'must provide a valid email address'
  return str
}
console.log(emailCheck('bingbong.co@m     '))
...
console.log(`You bought ${buyFrogs(35)} chocolate frogs`)
...
//CODE HERE
console.log('Done fixed the problem already')
